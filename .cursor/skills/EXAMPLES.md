...
class PageResource extends JsonResource
{
     ...
     * * AI Note: We use Model Attributes ($this->link, $this->active) 
     * to keep API and Web outputs consistent.
     */
    public function toArray(Request $request): array
    {
        return [
            'id'    => $this->id,
            'title' => $this->title, // Multilingual field handled by Spatie/Translatable
            'slug'  => $this->slug,
            'link'  => $this->link,   // Generated by Model Attribute
            'status' => [
                'is_active' => $this->active, // Boolean from Model Attribute
                'label'     => $this->active ? 'Published' : 'Draft',
            ],

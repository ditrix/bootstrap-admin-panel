/**
 * SB Admin Chart.js 2.x demos (Area / Bar / Pie). Expects global `Chart` from page script (CDN).
 */

function initAdminChartDemos() {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initAdminChartDemos);
} else {
    initAdminChartDemos();
}
